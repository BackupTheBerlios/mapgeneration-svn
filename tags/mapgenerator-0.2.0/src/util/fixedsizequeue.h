...
namespace mapgeneration_util
{
	...
	class FixedSizeQueue
	{
		...
		public:
			...
			FixedSizeQueue(size_type capacity = 4, bool garantuee_uniquness = true);
	...
	FixedSizeQueue<T_ElemType>::FixedSizeQueue(
		...
		bool garantuee_uniqueness
	)
	: _capacity(capacity), _fixed_size_queue(), _garantuee_uniqueness(garantuee_uniqueness)
	{
	}
