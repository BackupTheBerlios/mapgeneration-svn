...
namespace mapgeneration
{
	...
	class GPSPoint : public Direction, public GeoCoordinate {
		...
		public:
			...
			inline bool
			operator==(const GPSPoint& gps_point) const;
	...
	inline bool
	GPSPoint::operator==(const GPSPoint& gps_point) const
	{
		/** @todo Write some docu. And is that enough? */
		return GeoCoordinate::operator==(gps_point);
	}
